...
public class Main {
    ...
    static String[] hondaModels = {
            "Accord","Civic","Fit"
    };
    static String[] toyotaModels = {
            "Camry", "Corolla", "Helix"
    };
    static String[] nissanModels = {
            "Altima", "Maxima", "Sentra"
    };

    static String[] transmissions = {
            "CVT", "Auto", "Manual"
    };
    static String[] engines = {
            "2.5 L4", "1.6 Turbo", "3.7 V6", "2.0 Twin Turbo"
    };
    static String[] driveType = {
            "AWD", "FWD", "RWD"
    };
    static String[] trims = {
            "Sport", "Premium", "Grand Touring"
    };
    static String[] colors = {
            "Metallic Black", "Midnight Purple", "Ceramic White", "Silver Grey", "Lunar Blue", "Bourbon Red", "Gunmetal Grey", "Java Brown"
    };
